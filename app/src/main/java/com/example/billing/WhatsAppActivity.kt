...
class WhatsAppActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // ✅ TAMBAHAN (ambil branch id dari MainActivity)
        ...
        btnSend.setOnClickListener {
            ...
            val builder = MultipartBody.Builder()
                ...
                .addFormDataPart("branch_id", branchId ?: "")   // ✅ TAMBAHAN
                    ...
                    override fun onResponse(
                        ...
                        if (response.isSuccessful && response.body()?.message == "Voucher berhasil digunakan") {
                            ...
                            try {
                                ...
                                val overlayIntent =
                                    Intent(this@WhatsAppActivity, TimerOverlayService::class.java).apply {
